...
class Robot:
    def act(self, game):
        ...
        suntzu = {loc for loc in adjacent if around(loc) & enemy}
        safemove = adjacent-adjacent_enemy-adjacent_enemy2-team-taken_moves-spawn
        safemove_withspawn = adjacent-adjacent_enemy-adjacent_enemy2-team-taken_moves
        if turn_number % 10 == 1:
            safemove = safemove_withspawn
        ...
        if not move:
            ...
            if safemove:
                if moment == 0:
                    ...
                    move = moving(mindist(safemove, closest_team))
            else:
